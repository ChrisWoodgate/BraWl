...
A nested sampling run needs the following input files:
 - The file 'brawl.inp' contains all relevant parameters for the simulation, while 'fcc_al_1.00_crfeconi.vij' contains the atom-atom interaction parameters.
 - The file 'ns_input.txt' contains the relevant nested sampling parameters.

Run '/path/to/brawl/brawl.run' to launch the simulation. Once it has finished, analyse the results using pymatnest, and plot them the output using `01_analyse.py`.
